...
class GetBookedFitClasses {
    constructor() {
        this.path = "/fitclasses/get_booked_classes";
    ...
    initializeRoutes() {
        ...
        ], validateReq_1.validatereq, fit_1.fitController.get_booked_classes);
    }
}
exports.default = GetBookedFitClasses;
